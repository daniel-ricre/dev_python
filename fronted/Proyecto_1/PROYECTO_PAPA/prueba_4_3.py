...
layout = [
    ...
    # === CONTENIDO PRINCIPAL ===
    [
        # COLUMNA IZQUIERDA: Tabla de registros (ÚNICA TABLA)
        sg.Column([
        ...
        sg.Column([
            ...
            # Campos con etiquetas que cambiarán dinámicamente
    ...
    # === BARRA DE ESTADO ===
    [sg.HorizontalSeparator()],
    [sg.Text('💡 Tip: Las etiquetas del formulario cambian según la categoría seleccionada',
             text_color='gray', font=('Arial', 9), expand_x=True)]
]

# --- Crear ventana principal ---
window = sg.Window('Tienda Registro - Sistema de Inventario',
                   layout,
                   size=(1050, 650),
                   resizable=True,
                   finalize=True)
...
# --- Función para cambiar de categoría (ACTUALIZA LAS ETIQUETAS) ---
...
while True:
    ...
    # Cambiar categoría (con actualización de etiquetas)
    if event == '-CAT_VINO-':
