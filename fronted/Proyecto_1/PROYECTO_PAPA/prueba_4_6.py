...
def inicializar_excel():
    ...
    if not os.path.exists(ARCHIVO_EXCEL):
        ...
        for categoria, etiquetas in ETIQUETAS_CATEGORIA.items():
            ...
            # Dejar 2 filas vacías entre tablas
            fila_actual += 2
...
layout = [
    ...
    # === BARRA DE ESTADO ===
    [sg.HorizontalSeparator()],
    [sg.Text('💡 Tip: El archivo Excel muestra TRES TABLAS en UNA SOLA HOJA: VINO, LATAS y DULCES',
             text_color='gray', font=('Arial', 9), expand_x=True)]
]

# --- Crear ventana principal ---
window = sg.Window('Tienda Registro - 3 Tablas en 1 Hoja Excel',
                   layout,
                   size=(1050, 650),
                   resizable=True,
                   finalize=True)
