...
def inicializar_excel():
    """Crea el archivo Excel con las tres hojas vacías si no existe"""
...
# --- Función CORREGIDA para guardar en la hoja correspondiente ---


def guardar_en_excel(categoria, nombre, cantidad, fecha_registro=None):
    """Guarda un nuevo registro en la hoja específica sin borrar las otras"""
    ...
    try:
        ...
        # Leer la hoja específica a un DataFrame
...
def filtrar_por_fecha(categoria, fecha_objetivo):
    ...
    try:
        ...
        libro = load_workbook(ARCHIVO_EXCEL, read_only=True)
...
window = sg.Window('Tienda Registro - Sistema de Inventario (Excel con 3 Hojas)',
                   layout,
                   size=(1050, 650),
                   resizable=True,
                   finalize=True)
